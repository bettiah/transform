...
export class Event {
  ...
  type!: RoomEventType | MessageEventType | string; //	Required. The type of event. This SHOULD be namespaced similar to Java package naming conventions e.g. 'com.example.subdomain.event.type'}
}
...
export class RoomEvent {
  content?: RoomEventContent; //	The fields in this object will vary depending on the type of event. When interacting with the REST API, this is the HTTP body.
  type!: RoomEventType; //	Required. The type of event. This SHOULD be namespaced similar to Java package naming conventions e.g. 'com.example.subdomain.event.type'}
...
export class ImageEventContent {
  ...
  info?: ImageInfo; //	Metadata about the image referred to in url.
  msgtype!: MsgType.image; //	Required. Must be 'm.image'.
  url!: string; //	Required. The URL to the image.
}
// 11.2.1.7.5
export class FileEventContent {
  ...
  msgtype!: MsgType.file; //	Required. Must be 'm.file'.
...
export class LocationEventContent {
  ...
  msgtype!: MsgType.location; //	Required. Must be 'm.location'.
  info!: LocationInfo; //
}
...
export class VideoEventContent {
  ...
  msgtype!: MsgType.video; //	Required. Must be 'm.video'.
...
export class StateEvent {
  content?: StateEventContent; //	The fields in this object will vary depending on the type of event. When interacting with the REST API, this is the HTTP body.
  type!: RoomEventType; //	Required. The type of event. This SHOULD be namespaced similar to Java package naming conventions e.g. 'com.example.subdomain.event.type'}
