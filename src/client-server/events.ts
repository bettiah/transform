...
// 11.11.1.1
export class HistoryVisibilityContent {
  @IsIn(['invited', 'joined', 'shared', 'world_readable'])
  history_visibility!: 'invited' | 'joined' | 'shared' | 'world_readable';
}
export class HistoryVisibilityEvent extends StateEvent {
  @Equals(StateEventType.history_visibility) type!: StateEventType;
